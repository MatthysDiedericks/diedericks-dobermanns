...
export type TablesInsert<_TableName extends string = string> = Record<string, unknown>;

export type TablesUpdate<_TableName extends string = string> = Record<string, unknown>;
