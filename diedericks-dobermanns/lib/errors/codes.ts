...
export const ERROR_CODES = {
  ...
  DELIVERY_CONFIRMED_BY_CLIENT: "DELIVERY_CONFIRMED_BY_CLIENT",
  ...
  APPLY_DOG_REQUESTS_FAILED: "APPLY_DOG_REQUESTS_FAILED",
...
export const CODE_SEVERITY: Record<ErrorCode, ErrorSeverity> = {
  ...
  DELIVERY_CONFIRMED_BY_CLIENT: "warning",
  ...
  APPLY_DOG_REQUESTS_FAILED: "warning",
  APPLY_DUPLICATE_SUPPRESSED: "warning",
...
export const IMMEDIATE_ALERT_CODES: ReadonlySet<string> = new Set([
  ...
  ERROR_CODES.DELIVERY_CONFIRMED_BY_CLIENT,
