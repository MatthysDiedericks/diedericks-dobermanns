-- 19 Aug live ceilings for the whole business (already decided; this file records them).
-- Application 50/hour 200/day, enquiry 100/hour, error_events 300/hour, sign-in 60/15min.
-- Same to_jsonb SECURITY_% bypass and log_security_event as 0102. Never new.code.
-- Do not tighten these until keys are genuinely per-person and we say so explicitly.
-- Idempotent. Never revoke EXECUTE on is_admin().
...
values ('0106', 'rate_limit_business_ceilings')
